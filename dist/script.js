...
function populateDropdowns() {
    ...
    // Set some defaults or use pre-injected variables from pSEO build
    elements.originSelect.value = window.INITIAL_ORIGIN || 'US';
    elements.destSelect.value = window.INITIAL_DEST || 'UK';
}
